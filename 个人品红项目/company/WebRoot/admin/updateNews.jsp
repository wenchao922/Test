...
function fun_check_form(){
 ...
 <body> 
		 ...
		 %>
  	<form name="form1" action="doAddNews.jsp?type=2&newsId=<%=n.getNewsId() %>" method="post" onSubmit="return fun_check_form()">
		<table cellspacing="1" cellpadding="4" width="100%" class="tableborder" id="table3">
			...
			<tr>
				...
				<td class="altbg2" colspan="11">
					<input type="text" name="title" size="34" value="<%=n.getTitle() %>">
				</td>
			</tr>
			<tr>
				<td class="altbg1">
				...
				<td class="altbg2" colspan="11">
					<textarea rows="5" cols="60" name="content"><%=n.getContent() %></textarea>
				</td>
			</tr>
