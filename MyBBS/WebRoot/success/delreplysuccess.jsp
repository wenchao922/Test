...
<HTML>
<HEAD>
<TITLE><%=Constant.BBS_TITLE %>删帖</TITLE>
...
<DIV class="t" align="center">
	<BR/>
	<font color="red">删除回复成功!</font>
	<BR/><BR/>
	<input type="button" value="返 回" onclick="location='<%=path%>/detail.jsp?topicId=<%=request.getParameter("topicId") %>'; " class="btn"/>
	<BR/><BR/>
</DIV>
<!--      声明        -->
<BR/>
